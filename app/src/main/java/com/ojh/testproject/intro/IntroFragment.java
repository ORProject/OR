...
public class IntroFragment extends Fragment {
    ...
    public static final int IMG_INTRO[] = {android.R.drawable.ic_lock_idle_alarm, android.R.drawable.ic_delete, android.R.drawable.ic_dialog_info, android.R.mipmap.sym_def_app_icon};
