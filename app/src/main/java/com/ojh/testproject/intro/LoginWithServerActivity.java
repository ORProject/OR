...
public class LoginWithServerActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //백앤드에서 토큰얻을려면 resquestIdToken을 사용해야함함
...
//        Toast.makeText(getApplicationContext(),"로긴버튼",Toast.LENGTH_SHORT).show();
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            startActivity(new Intent(LoginWithServerActivity.this, MainActivity.class));
            finish();
        } else {
